...
class MainActivity : AppCompatActivity() {
    ...
    private fun analyzeSentiment(text: String) {
        val apiKey ="AIzaSyAOIwBPafxspza1IUcEV4cw1kGtES16pD4"

        CoroutineScope(Dispatchers.IO).launch {
            val responseText = SentimentApiService.callSentimentApi(text, apiKey)
            val sentiment = SentimentAnalyzer.extractSentiment(responseText)
